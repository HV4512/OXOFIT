...
public class MainActivity extends AppCompatActivity {
    ...
    public void switchOXO(View view)
    {
      Toast.makeText( this,"Switching to FiTOxO Tracker Module", Toast.LENGTH_SHORT).show();
//        Intent i = getPackageManager().getLaunchIntentForPackage("com.google.android.apps.maps");
          Intent i = getPackageManager().getLaunchIntentForPackage("com.easyfitness.debug");
//          Intent i = getPackageManager().getLaunchIntentForPackage("com.anibalventura.t7minutesworkout");
    ...
    public void quickmin(View view)
    {
        Toast.makeText( this,"Switching to FiTOxO Workout Module", Toast.LENGTH_SHORT).show();
//        Intent i = getPackageManager().getLaunchIntentForPackage("com.google.android.apps.maps");
//          Intent j = getPackageManager().getLaunchIntentForPackage("com.easyfitness.debug");
          Intent j = getPackageManager().getLaunchIntentForPackage("com.anibalventura.t7minutesworkout");
